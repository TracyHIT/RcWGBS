...
#make_tain_Rdata (cov_filename = "data/Compare_sc/HepG2_2_hg38.cov", flank_size = 50,
                            output_prefix = "data/Train_Test_Data/HepG2_2_hg38", train_size = 100000,ref_genome_dir="/home/zqluoximei/ref_hg38/hg38/",file_type = ".txt",cov_cutoff_low=50,cov_cutoff_high=-1)

#make_lowcov_test_data_from_all(cov_filename = "data/Compare_sc/HepG2_2_hg38.cov", flank_size = 50,
#                                             output_prefix = "data/Train_Test_Data/HepG2_2_hg38.lowcov", pre_DNA_inter_dir="data/All_DNA/",
#                                            file_type = ".gz",cov_cutoff=3,
 #                                            cov_high_threshold=1000)
#
